...
public class PlayerPairingGeneralTab
{
    public static void DrawGeneralTab(PairedPlayer SelectedPlayer)
    {
        ...
        DrawEncryptionKeysComponent(SelectedPlayer);
    }

    public static void DrawEncryptionKeysComponent(PairedPlayer SelectedPlayer)
    {
